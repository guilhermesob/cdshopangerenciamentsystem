	...
	<section class="ftco-section">
	    ...
	    <div class="container">
          ...
          <li class="nav-item"><a href="menu.php" class="nav-link">Menu</a></li>
	        	<li class="nav-item active"><a href="#" class="nav-link">Lançamentos</a></li>
