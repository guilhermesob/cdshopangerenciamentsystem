...
$sql= "UPDATE cds SET nome='$nome',titulo='$titulo', genero='$genero', artista='$artista', descricao='$descricao' , preco='$preco', ano='$ano', procedencia='$procedencia', tempo='$tempo', promocao='$promocao', lancamento='$lancamento', tempo='$tempo', disponibilidade='$disponibilidade', img='$img' WHERE id='$id'";
