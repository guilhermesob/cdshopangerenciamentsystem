	    ...
	    <div class="container">
          ...
          <li class="nav-item dropdown">
              ...
              <li class="nav-item"><a href="carrinho.php?id=<?php echo $id?>" class="nav-link">Carrinho</a></li>
	        	<li class="nav-item active"><a href="perfil.php?id=<?php echo $id?>" class="nav-link">Perfil
...
?>
  ...
  <br>
  <form action="cadastrar1.php" method="POST" enctype="multipart/form-data" class="needs-validation">    
  <div style="margin:4px">
  <input style="border-radius:10px" type="hidden" name="id" id="id" value="<?php echo $id?>" required>
<br>      
  <label style="margin-left: 20px;color:#0000ff">Nome</label>
<input style="border-radius:10px" type="text" name="nome" id="nome" placeholder="Digite seu nome" value="<?php echo $nome?>" required>
</div>
<div style="margin:4px">
<label style="margin-left: 25px;color:#0000ff">Email</label>
<input style="border-radius:10px" type="e-mail" name="email" id="email" placeholder="Digite seu email" value="<?php echo $email?>" required>
</div>
<div style="margin:4px">
<label style="margin-left: 20px;color:#0000ff">Senha</label>
<input style="border-radius:10px" type="text" name="senha" id="floatingInput" placeholder="Digite sua senha" value="<?php echo $senha?>" required>
</div>
<div style="margin:4px">
<label style="color:#0000ff">Telefone</label>
<input style="border-radius:10px" type="int" name="telefone" id="telefone" placeholder="Digite seu telefone" value="<?php echo $telefone?>" required>
</div>  
  <div style="margin:3px">
<label style="margin-left: 30px;color:#0000ff">CPF</label>
  <input style="border-radius:10px" type="text" name="cpf" id="cpf" placeholder="Digite seu CPF" value="<?php echo $cpf?>" required>
</div>
<div>
<label style="margin-left: 150px;color:#0000ff">img</label>
<input style="border-radius:10px;background-color:#222244" type="file" name="img">
</div>
