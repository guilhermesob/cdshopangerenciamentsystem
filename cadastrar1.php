...
if(mysqli_query($conexao,$sql)){
 echo "<p style='align:center; color:#0f0'>"."Usuario editado com sucesso!"."</p>";
} else{
 echo "<p style='align:center; color:#f33'>"."Não foi possivel editar o clientes"."</p>". mysqli_error($conexao);
}
?>
</div>
</section>
